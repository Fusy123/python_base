...
# TODO 1 - просить ввести число
# TODO 2 - делать проверку числа, используя функцию которую у вас объявлена в движке!
# TODO if checking_number_correct(число_которое_ввели_выше):
# TODO 3 - печатать принты, об успешно или не успешном вводе.
# TODO 4 - если ввод успешен то выпускать из функции дальше.
