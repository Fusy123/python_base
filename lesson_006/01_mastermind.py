...
def play_game():
    ...
    count_games = 1
    # TODO теперь нам нужно эту часть кода разбить на блоки логические независимые блоки и вынести их в функции
    # TODO в while True будет только вызов этих функций по по порядку!

    # TODO Алгоритм примерно такой:

    # TODO просим_ввести_число_корректное() - функция  # функция проверки числа есть, но вы сказали что в функциях
